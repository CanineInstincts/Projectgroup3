...
draw_sprite(sFoodbar_Icon,0, camxview + 40, camyview + 50);
//draw_sprite(sFoodbar_Bar,0, camxview + 80, camyview + 50);
draw_sprite(sFoodbar_Bar_container,0, camxview + 90, camyview + 50);
draw_sprite_stretched(sFoodbar_Bar,0, camxview + 90, camyview + 50, global.foodTarget, 8);
